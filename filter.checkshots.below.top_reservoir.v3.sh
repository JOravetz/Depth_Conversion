...
rm -f FIELD_wells_with_checkshots_MISSING_WMPs.FILTERED.dat
...
END`
   ...
   if [ -z "${TEST}" ] ; then
      ...
      echo ${LINE} >> FIELD_wells_with_checkshots_MISSING_WMPs.FILTERED.dat
   fi
done < FIELD_wells_with_checkshots_MISSING_WMPs.dat
