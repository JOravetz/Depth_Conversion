...
int main (int argc, char **argv) {
   ...
   if (!getparstring("pfile",&pfile)) pfile = "gridder2.su";

   if (!getpardouble("delta_x",&delta_x)) delta_x = 15.55217765;
   if (!getpardouble("delta_y",&delta_y)) delta_y = 18.55744574;
   if (!getpardouble("delta_t",&delta_t)) delta_t = 1;
