...
extern int vzerok ( int *, double *, double *, double *, double *, double *, double * );
...
int main(int argc, char **argv) {
	...
	for (l=0;l<ntr;l++) {
	   ...
	   if ( check ) {
	      ...
	      if ( num > 1 ) {
	         vzerok ( &num, xin, yin, &vzero, &k, &vzero_out, &k_out );
...
int vzerok ( int *imax, double *tval, double *dval, double *vzero, double *k, double *vzero_out, double *k_out ) {
